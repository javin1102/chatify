...
import { setPersistence, browserSessionPersistence, AuthError } from "firebase/auth";
...
const LoginForm: React.FC = () => {
	...
	useEffect(() => {
		...
		if (error) {
			...
			if (error.code === "auth/user-not-found" || error.code === "auth/invalid-email") setEmailError(true);
		}
	}, [userAuth, error, dispatch]);
